...
HD_PWD='F:/programmeerbareHardware1/fullAdderSegment/fullAdderSegment.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fourBitAdderTop.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fourBitAdderTop.tcl -notrace

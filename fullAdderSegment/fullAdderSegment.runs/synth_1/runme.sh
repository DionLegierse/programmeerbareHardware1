...
HD_PWD='F:/programmeerbareHardware1/fullAdderSegment/fullAdderSegment.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fourBitAdderTop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fourBitAdderTop.tcl

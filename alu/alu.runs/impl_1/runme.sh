...
HD_PWD='C:/Users/djleg/Documents/programmeerbareHardware1/alu/alu.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log aluBoardTest.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source aluBoardTest.tcl -notrace

...
HD_PWD='C:/Users/djleg/Documents/programmeerbareHardware1/stopwatch/stopwatch.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log stopWatchTop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source stopWatchTop.tcl

...
HD_PWD='C:/Users/djleg/Documents/programmeerbareHardware1/stopwatch/stopwatch.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log stopWatchTop.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source stopWatchTop.tcl -notrace

...
HD_PWD='C:/Users/djleg/Documents/programmeerbareHardware1/fullAdder/fullAdder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fourBitFullAdder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fourBitFullAdder.tcl -notrace

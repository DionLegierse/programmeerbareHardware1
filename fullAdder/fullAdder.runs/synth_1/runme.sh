...
HD_PWD='C:/Users/djleg/Documents/programmeerbareHardware1/fullAdder/fullAdder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fourBitFullAdder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fourBitFullAdder.tcl

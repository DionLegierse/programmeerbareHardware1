...
HD_PWD='C:/Users/djleg/Documents/programmeerbareHardware1/VGASquare/VGASquare.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log topLevelVGA.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source topLevelVGA.tcl

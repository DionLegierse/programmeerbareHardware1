...
HD_PWD='C:/Users/djleg/Documents/programmeerbareHardware1/VGASquare/VGASquare.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log topLevelVGA.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source topLevelVGA.tcl -notrace
